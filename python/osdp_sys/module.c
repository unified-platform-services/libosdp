...
#define ADD_CONST(k, v) PyModule_AddIntConstant(module, k, v);
	...
	/* For `osdp_mp_notification::mp_type` and ControlPanel.cancel() */
	ADD_CONST("MP_MSG_FILE_TRANSFER", OSDP_MP_MSG_FILE_TRANSFER);
	ADD_CONST("MP_MSG_PIV", OSDP_MP_MSG_PIV);
	ADD_CONST("MP_MSG_GENAUTH", OSDP_MP_MSG_GENAUTH);
	ADD_CONST("MP_MSG_CRAUTH", OSDP_MP_MSG_CRAUTH);
	ADD_CONST("MP_MSG_BIOREAD", OSDP_MP_MSG_BIOREAD);
	...
	ADD_CONST("NOTIFICATION_PD_ID", OSDP_NOTIFICATION_PD_ID);
