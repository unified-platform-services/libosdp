...
#define ADD_CONST(k, v) PyModule_AddIntConstant(module, k, v);
	...
	ADD_CONST("BIO_TYPE_RIGHT_THUMB_PRINT", OSDP_BIO_TYPE_RIGHT_THUMB_PRINT);
	ADD_CONST("BIO_TYPE_RIGHT_INDEX_FINGER_PRINT", OSDP_BIO_TYPE_RIGHT_INDEX_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_RIGHT_MIDDLE_FINGER_PRINT", OSDP_BIO_TYPE_RIGHT_MIDDLE_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_RIGHT_RING_FINGER_PRINT", OSDP_BIO_TYPE_RIGHT_RING_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_RIGHT_LITTLE_FINGER_PRINT", OSDP_BIO_TYPE_RIGHT_LITTLE_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_LEFT_THUMB_PRINT", OSDP_BIO_TYPE_LEFT_THUMB_PRINT);
	ADD_CONST("BIO_TYPE_LEFT_INDEX_FINGER_PRINT", OSDP_BIO_TYPE_LEFT_INDEX_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_LEFT_MIDDLE_FINGER_PRINT", OSDP_BIO_TYPE_LEFT_MIDDLE_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_LEFT_RING_FINGER_PRINT", OSDP_BIO_TYPE_LEFT_RING_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_LEFT_LITTLE_FINGER_PRINT", OSDP_BIO_TYPE_LEFT_LITTLE_FINGER_PRINT);
	ADD_CONST("BIO_TYPE_RIGHT_IRIS_SCAN", OSDP_BIO_TYPE_RIGHT_IRIS_SCAN);
	ADD_CONST("BIO_TYPE_RIGHT_RETINA_SCAN", OSDP_BIO_TYPE_RIGHT_RETINA_SCAN);
	...
	ADD_CONST("BIO_TYPE_RIGHT_HAND_GEOMETRY", OSDP_BIO_TYPE_RIGHT_HAND_GEOMETRY);
	ADD_CONST("BIO_TYPE_LEFT_HAND_GEOMETRY", OSDP_BIO_TYPE_LEFT_HAND_GEOMETRY);
